...
@Component({
  ...
  templateUrl: './unassign-document-tag.component.html',
  styleUrls: ['./unassign-document-tag.component.less']
})
export class UnassignDocumentTagComponent {
  ...
  onButtonClick(): void {
    ...
    documentId: documentIdNumber;
      ...
      this.tagAssociationService
          .unassignTagFromDocument(tagIdNumber, documentIdNumber)
          .pipe(first())
          .subscribe(() => {
